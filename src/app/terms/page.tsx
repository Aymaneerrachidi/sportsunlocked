...
export default function TermsPage() {
  return (
    <main className="legal-page">
      ...
      <p>
        The site may reference, link to, or embed third-party sources for event availability. SportUnlocked does not
        control third-party services and is not responsible for their availability, content, advertising, cookies, or
        behavior.
      </p>
      ...
      <p>
        ...
        and availability signals. Third-party materials remain the responsibility of their respective services and
        rights holders.
      </p>
      ...
      <p>
        ...
        believe content on this site infringes your rights, contact us with the relevant page URL, your organization,
        and details that help us review the request.
      </p>
